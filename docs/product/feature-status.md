...
| P2 Kanban 基础能力 | 已实现/P2 | 管理员项目详情提供关系视图/Kanban 切换；Feedback 与 WorkTask 使用独立原生状态泳道，状态保存经 `POST /api/admin/project/item/status`、项目范围校验和 `project.item.status` 审计；公共投影不含工作项或 Kanban |
